...
export const LoanLimitSimulationMfacil = () => {
        ...
        <SimpleGrid>
          <Box w="354px">
            ...
            >
              ...
              <option value={ 211 }>211 - SPPREV</option>
              <option value={ 212 }>212 - POLÍCIA MILITAR</option>
              <option value={ 209 }>209 - SEFAZ</option>
              <option value={ 210 }>210 - SEFAZ 17 COMISSIONADO</option>
              <option value={ 214 }>214 - PREF SÃO PAULO</option>
              <option value={ 215 }>215 - IPREM</option>
            </Select>
      ...
      <TableContainer my="25px" mx="auto" p="15px" w="500px" border="1px" borderRadius="10px" borderColor="gray.200">
        <Table variant='striped'>
          <Tbody>
            ...
            <Tr>
              <Td>Valor Compra:</Td>
              <Td>{ formatCurrency(loanLimitSimulation.purchaseAmount) }</Td>
            </Tr>
            <Tr>
  ...
  return (
    <>
      <Header />
      <PageTitle title=" Consutar Limite Mfácil" />
      { renderingForm() }
